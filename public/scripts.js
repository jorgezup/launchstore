const Mask = {
    ...
    cpfCnpj(value) {
        value = value.replace(/\D/g, "") /* Deixa somente os números */
...
const PhotosUpload = {
    ...
    hasLimit(event) {
        ...
        /* Limitação para o Primeiro Upload */
        ...
        /* Limitação para o Photos Preview */
        const photosDiv = []
    ...
    removePhoto(event) {
        const photoDiv = event.target.parentNode //tag i (event target) e parentNode é div photos
